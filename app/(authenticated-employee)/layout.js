...
export function useAuth() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      // Since we're already in the employee section, assume user wants
      // to access with employee role and don't redirect
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      if (error || !data.user) {
        ...
        // Since we're already in employee section, assume the user wants to use employee view
        setUser(data.user);
      }
      setLoading(false);
    };
