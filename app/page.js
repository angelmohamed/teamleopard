    ...
    <div className="bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white text-slate-100 shadow-lg">
        <div className="flex justify-between items-center px-4 py-2">
          <h1 className="text-xl text-black font-bold">Connect</h1>
          <nav>
      ...
      <section className="flex justify-center items-center h-[75vh] min-h-[500px] text-white text-4xl font-bold py-6">
        ...
        <div className="w-1/2 flex flex-col items-center justify-left text-right px-10 gap-6">
          <h1 className="text-black text-6xl font-bold self-end mr-5">
            Name of the app or something.
          </h1>
          <p className="text-gray-600 text-4x1 italic self-end mr-5">
            get a job ️‍🔥️‍🔥.
          </p>
          <Button
            className="bg-slate-700 text-2xl self-end mr-5 bold italic"
            asChild
          >
        ...
        <Tabs defaultValue="personal" className="bg-slate-100">
          <TabsList className="w-full">
            <TabsTrigger value="personal" className="w-1/2 bg-slate-100">
              <h1 className="text-slate-800 text-2xl italic font-bold self-end mr-5">
                Job Hunters (might need a better word)
              </h1>
            </TabsTrigger>
          ...
          <TabsContent value="personal">
            <section
              ...
              style={{
                backgroundImage:
                  "url(https://media.gettyimages.com/id/1410538853/photo/young-man-in-the-public-park.jpg?s=612x612&w=gi&k=20&c=EpcwID8Bfxufrodoyo_x10JgFcnkPNuShJuJHRZkIlM=)",
          ...
          <TabsContent value="business">
            <section
              ...
              style={{
                backgroundImage:
                  "url(https://media.istockphoto.com/id/1696781145/photo/modern-building-in-the-city-with-blue-sky.jpg?s=612x612&w=0&k=20&c=POfayTyDe06tGX4CeJgS8-fb896MUC46dl3ZbHXBqN4=)",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
